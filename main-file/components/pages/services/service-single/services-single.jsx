                ...
                <div className="row">
                    <div className="col-xl-12">
                        ...
                        <div className="service__details-content">
                            ...
                            {/* TTLocks Gallery for Hospitality Digitalization Service */}
                            {serviceDetails?.id === 'hospitality-digitalization' && (
                                <section className="ttlocks__gallery-section mt-5 mb-5" aria-label="Smart Lock Technology Showcase">
                                    <header>
                                        <h3 className="sub-heading">Smart Lock Technology Showcase</h3>
                                        <p>Explore our innovative smart lock solutions designed for modern hospitality management.</p>
                                    </header>
                            ...
                            <p>We provide comprehensive {serviceDetails.title.toLowerCase()} solutions tailored to your business needs. Our expert team delivers cutting-edge technology solutions that drive growth and efficiency.</p>
                            ...
                            <div className="service__details-content-box">
                                <div className="service__details-content-box-single">
                                    ...
                                    <p>Our {serviceDetails.title.toLowerCase()} services include a comprehensive suite of features designed to meet modern business requirements.</p>
                                ...
                                <div className="service__details-content-box-single">
                                    ...
                                    <h4 className="mb-4">Business Benefits</h4>
                                    <p className="m-0">Transform your business operations with our {serviceDetails.title.toLowerCase()} solutions that deliver measurable results and competitive advantages.</p>
                                </div>
                            </div>
                                ...
                                <div className="col-md-6">
                                    {serviceDetails.benefits?.slice(0, 3).map((benefit, index) => (
                                        <div key={index} className="benefit-item mb-4">
                                            ...
                                            <p>Experience improved efficiency and results with our proven {serviceDetails.title.toLowerCase()} methodologies.</p>
                                        </div>
                                    ))}
                                </div>
                                <div className="col-md-6">
                                    {serviceDetails.benefits?.slice(3, 6).map((benefit, index) => (
                                        <div key={index} className="benefit-item mb-4">
                                            <h5><i className="flaticon-check me-2"></i>{benefit}</h5>
                                            <p>Leverage our expertise to achieve your business goals with cutting-edge {serviceDetails.title.toLowerCase()} solutions.</p>
                                        </div>
                                    ))}
                                </div>
                            </div>
                            ...
                            <h3 className="sub-heading">Technologies & Tools We Use</h3>
                            ...
                            <div className="cta-section mt-5 p-4 bg-light rounded">
                                <div className="row align-items-center">
                                    <div className="col-md-8">
                                        <h4>Ready to Transform Your Business with {serviceDetails.title}?</h4>
                                        <p className="mb-0">Let's discuss how our {serviceDetails.title.toLowerCase()} services can help you achieve your business objectives and stay ahead of the competition.</p>
                                    </div>
